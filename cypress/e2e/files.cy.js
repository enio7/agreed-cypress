...
describe('Files upload', () => {
  ...
  it('files upload from idea overview', () => {
    ...
    cy.get(
      'div:last-child > div > div.d-flex.align-items-center > div > div > button:nth-child(2)'
    ).click();
    ...
    cy.get(
      'div:last-child > div > div.d-flex.align-items-center > div > div > button:nth-child(3)'
    ).click();
    cy.reload();
    cy.get(
      'div.row.w-100 > div:last-child > div > div.d-flex.align-items-center > div'
    ...
    cy.get(
      'div:last-child > div > div.d-flex.align-items-center > div > div > button:nth-child(4)'
    ).click();
  });

  it('files upload from files tab', () => {
    cy.get(':nth-child(1) > a > .nav-item > .nav-link').click();
    cy.get('[data-number="0"]').click();
    ...
    cy.get(
      'div.opportunity-files-list > div:last-child > div:last-child > div'
    ).click();
