...
describe('Milestone', () => {
  ...
  it.skip('new milestone', { defaultCommandTimeout: 5000 }, () => {
    ...
    cy.wait(7000);
    cy.get('[role="rowgroup"] > tr:last-child > td:nth-child(1) > div > textarea').type('milestone title automated');
    cy.wait(2000);
    cy.get('[role="rowgroup"] > tr:last-child > td:nth-child(2) > div > textarea').type('milestone description long text here');
    cy.get('tr:last-child > td:nth-child(3) > div > div > div > div > div > input').click({ force: true });
    cy.get('.react-datepicker__month > div:nth-child(4) > div:nth-child(4)').click();
    cy.get('[role="rowgroup"] > tr:last-child > td:nth-child(4) > div > div > div.email-dropdown-wrapper > div > input')
      .invoke('show')
      .click({ force: true });
    cy.get('[role="rowgroup"] > tr:last-child > td:nth-child(4) > div > div > div.email-dropdown-wrapper > div > input')
    ...
    cy.reload();
    cy.wait(1000);
    cy.get('[role="rowgroup"] > tr:last-child > td:nth-child(5) > div > div > div > div > button').click();
  ...
  it.skip('archive milestone row', () => {
    ...
    cy.get('[data-number="0"]').click();
    cy.get('.page-tabs__tabs__tab--name').contains('Plan').click();
    cy.get('tr:first-child > td:nth-child(6) > div > div > div > div > div').click();
