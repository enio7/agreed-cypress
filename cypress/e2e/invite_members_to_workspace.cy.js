...
describe('Inviting a new member to workspace', () => {
  ...
  it('inviting a member to workspace through homepage', () => {
    ...
    cy.get('div > div.col-12 > div.row > div:nth-child(2) > div.row > div > div:nth-child(1)').click();
  ...
  it('invite members to workspace through workspace members table', () => {
    ...
    cy.get(':nth-child(2) > .align-items-center > .d-flex > .profile-dropdown-item-info').click();
